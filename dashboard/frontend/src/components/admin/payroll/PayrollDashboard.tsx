  ...
  return (
    ...
    <div className="grid grid-cols-1 gap-6 mb-6">
      ...
      <div className="mt-6 flex flex-wrap justify-center gap-4">
          ...
          <button className="w-48 px-4 py-3 bg-red-600 text-white rounded-lg hover:bg-red-700">
            <FaFilePdf className="mr-2 inline" />
            Generate PDF
          </button>
          <button className="w-48 px-4 py-3 bg-green-600 text-white rounded-lg hover:bg-green-700">
